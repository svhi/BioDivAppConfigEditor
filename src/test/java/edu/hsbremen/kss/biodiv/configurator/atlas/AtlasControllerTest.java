...
public class AtlasControllerTest {
    ...
    public void setUp() throws Exception {
        mvc = MockMvcBuilders.standaloneSetup(new AtlasController()).build();
    }

    @Test
    public void getHello() throws Exception {
        mvc.perform(MockMvcRequestBuilders.get("/api/atlas/").accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
                //.andExpect(content().string(equalTo("{\"id\":1,\"name\":\"Hello, World!\",\"baseUrl\":\"Hello, World!\"}")));
    }
}
